...
public class Database {
	...
	public void executeCommand(String sqlCommand) throws SQLException {
		...
		// various replacements to clean up the command.
//		sqlCommand = sqlCommand.replace("=C4", "Ä");
//		sqlCommand = sqlCommand.replace("ä", "ae");
//		sqlCommand = sqlCommand.replace("ö", "oe");
//		sqlCommand = sqlCommand.replace("ü", "ue");
//		sqlCommand = sqlCommand.replace("Ä", "Ae");
//		sqlCommand = sqlCommand.replace("Ö", "Oe");
//		sqlCommand = sqlCommand.replace("Ü", "Ue");
//		sqlCommand = sqlCommand.replace("ß", "ss");
		sqlCommand = StringUtils.only8bit(sqlCommand);
