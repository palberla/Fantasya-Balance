...
public class Rekrutieren extends EVABase
{
	...
	public void DoAction(Region r, String befehl) {
		...
		for (Einzelbefehl eb : befehle) {
            ...
            wants += anzahl * ( 1.0 / u.rekrutierungsFaktor(u.getCoords()) ); // und Wunsch merken
		...
		for (Einzelbefehl eb : befehle) {
			...
			if (u.wants > 0) {
				...
				if ((wants * ( 1.0 / u.rekrutierungsFaktor(u.getCoords()))) > rekruten) wants = (int) (rekruten  * u.rekrutierungsFaktor(u.getCoords()));
