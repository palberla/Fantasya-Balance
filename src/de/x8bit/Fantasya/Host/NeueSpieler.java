...
public class NeueSpieler
{
	...
	private static void NeueEinheiten(Region region, Partei volk, String tarnung, int holz, int steine, int eisen)
	{
		...
		Class<?> skills[] = { 
                            ...
                            Tierdressur.class, Reiten.class, 
                            Architektur.class, Strassenbau.class,
                            Schiffbau.class, Seefahrt.class, 
                            Wagenbau.class,
                            Handel.class,
                            Ausdauer.class, 
                            Tarnung.class,
	...
	private static Unit NeueEinheitErzeugen(Coords coords, Partei volk, String tarnung, int personen)
	{
		...
		if (u.darfRasseTarnen()) {
			// wird nur von Rassen verwendet, die sich tarnen duefen, sonst wird es ignoriert.
			u.setTarnRasse(tarnung);
		}
		u.hinzufuegenStartFertigkeiten(u.getPersonen());
		return u;
	}
