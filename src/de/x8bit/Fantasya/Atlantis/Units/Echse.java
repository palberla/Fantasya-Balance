...
public class Echse extends Unit // SKILL
{
	...
	@Override
	public boolean darfRasseTarnen() { return true; };
	...
	public int Talentwert(Skill skill)
	{
		...
		if (skill.getClass().equals(Seefahrt.class))			tw +=  0;	// SKILL
		...
		if (skill.getClass().equals(Ausdauer.class))			tw +=  2;	// SKILL

		
		Region r = Region.Load(this.getCoords());
		if (r.getTyp().equals(Sumpf.class.getSimpleName()) || r.getTyp().equals(Wueste.class.getSimpleName()))
		{
			tw +=  1;
			if (skill.getClass().equals(Handel.class)) tw +=  1;
		}
		else if (r.getTyp().equals(Gletscher.class.getSimpleName()) || r.getTyp().equals(Berge.class.getSimpleName())) tw -=  1;
	 ...
	 */
	public double rekrutierungsFaktor(Coords coords)
	{
		Region r = Region.Load(this.getCoords());
		if (r.getTyp().equals(Sumpf.class.getSimpleName()) || r.getTyp().equals(Wueste.class.getSimpleName())) return 2.0;
		
		if (r.getTyp().equals(Gletscher.class.getSimpleName()) || r.getTyp().equals(Berge.class.getSimpleName())) return 0.5;
